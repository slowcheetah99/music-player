...
export default function Loader({ params }) {
  return (
    <motion.div
      className="grid place-items-center bg-[#111] border-2 border-secondary"
      initial={
        params !== undefined
      ...
      animate={
        params !== undefined ? { width: "100vw", height: "100vh" } : "animate"
      }
      transition={{
        duration: 1,
        ease: "easeOut",
    ...
    >
      <div className="absolute top-0 left-0 w-1/2 h-full bg-[#111]" />
      <div className="absolute top-0 left-1/2 w-1/2 h-full bg-[#1e1e1e]" />
      <motion.svg
        width="664"
        height="653"
        viewBox="0 0 664 653"
        ...
        className="w-[400px] h-[400px] stroke-secondary z-50 mt-40"
        initial="hidden"
        animate="visible"
        exit="out"
        key="loader"
